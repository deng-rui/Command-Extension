...
public class Sensitive_Thesaurus {
	...
	static{
		Sensitive_Thesaurus.words = readTxtByLine(filePath);
		addBadWordToHashMap(Sensitive_Thesaurus.words);
	}
	...
	public static Set Sensitive_Thesaurus(String text) {
		Set<String> s = Sensitive_Thesaurus.words;
		Map<String,String> map = Sensitive_Thesaurus.wordMap;
